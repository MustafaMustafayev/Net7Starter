...
namespace DAL.Migrations
{
    ...
    [Migration("20240103184401_UserProfileFile")]
    partial class UserProfileFile
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ENTITIES.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("57670243-473b-4ad8-a37a-91eb7963e84b"),
                        ...
                        new
                        {
                            Id = new Guid("a9fe89b5-83e9-408a-9cac-ab74d8c71359"),
                            CreatedAt = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            IsDeleted = false,
                            Key = "Admin",
                            Name = "İnzibatçı"
                        ...
                        new
                        {
                            Id = new Guid("751a1aa0-58f0-4dbf-a1b3-c17aa96882c1"),
                            CreatedAt = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            IsDeleted = false,
                            Key = "User",
                            Name = "İstifadəçi"
                        ...
                        new
                        {
                            Id = new Guid("db637744-3a23-4269-9560-ab2302b45f7b"),
                            CreatedAt = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            IsDeleted = false,
                            Key = "Guest",
                            Name = "Qonaq"
            ...
            modelBuilder.Entity("ENTITIES.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("58c8e76f-eb92-4a85-b254-c8b3c4a1fa11"),
                            ContactNumber = "",
                            CreatedAt = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Email = "test@test.tst",
                            IsDeleted = false,
                            Password = "ihd5HgzbN5ui17anY2/kLK09RjMuNXQh/HbDqrGj6zWPyszCW5ZFXYHegXKiV+QMlqpVRZHSaCF68EYCOGZQuw==",
                            Salt = "VpWR9i0ZmOjFnxuckHA5OQ==",
                            Username = "Test"
                        });
                });
